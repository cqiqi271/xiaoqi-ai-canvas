...
- The first launch creates this computer's own data and API settings; it does not contain the creator's canvas, images, history, or API keys.

This is a self-contained local package. No GitHub is required.
